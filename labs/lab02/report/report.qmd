...
![V Создание папки на локальном компьютере и клонирование в git](image/create way_clone git.png){#fig-004 width=70%}


Перешли в каталог cd ~/work/study/2024-2025/"Операционные системы". Удаляем файл rm package.json ([рис. @fig-005])

![V Удаление файла rm package](image/delete rm package.png){#fig-005 width=70%}


Создаем необходимые каталоги и отправляем файлы на сервер. ([рис. @fig-006])

![V Создание каталогов и отправка в git](image/create and go to git.png){#fig-006 width=70%}

Продолжение - git push ([рис. @fig-007])

![V Git push](image/git push.png){#fig-007 width=70%}

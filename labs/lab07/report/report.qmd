...
В этой лабораторной работе мы познакомились с командной оболочкой Midnight Commander, её структурой и горячими клавишами. Изучили новые возможности управления файловой системой, выполнили данные нам задания.

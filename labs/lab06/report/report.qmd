...
![V Поиск файлов, начинающихся символа "c"](image/name_c.png){#fig-003 width=70%}

![V Поиск файлов, начинающихся символа "c"](image/name_c_2.png){#fig-004 width=70%}

5. Выведите на экран (по странично) имена файлов из каталога /etc, начинающиеся с символа h. ([рис. @fig-005])
